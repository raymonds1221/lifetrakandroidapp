...
public class ActigraphyFragment extends BaseFragment implements CalendarDateChangeListener {
	...
	private void initializeObjects() {
		...
		mAdapter = new ActigraphyAdapter(getChildFragmentManager(), date);
	...
	public void setDataWithDate(Date date) {
		ActigraphyItemFragment fragment1 = (ActigraphyItemFragment) mAdapter.instantiateItem(mActigraphyPager, 0);
		ActigraphyItemFragment fragment2 = (ActigraphyItemFragment) mAdapter.instantiateItem(mActigraphyPager, 1);
		ActigraphyItemFragment fragment3 = (ActigraphyItemFragment) mAdapter.instantiateItem(mActigraphyPager, 2);
