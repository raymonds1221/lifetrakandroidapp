...
public class SleepAsyncTask extends AsyncTask<String, Void, JSONObject> {
    ...
    public SleepAsyncTask(String string) {
        mErrorMessage = string;
    }

    public SleepAsyncTask listener(AsyncListener listener) {
        mListener = listener;
        return this;
    }
...
//        HttpPost post = new HttpPost(params[0]);
    ...
    public void onPostExecute(JSONObject result) {
        if    (mListener != null) {
            if (result != null) {
                try {
                    if (result.has("status") && (result.getString("status").equalsIgnoreCase("ok"))) {
    ...
    public SleepAsyncTask addParam(String key, String value) {
