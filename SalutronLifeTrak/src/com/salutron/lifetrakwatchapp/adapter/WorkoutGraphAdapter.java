...
public class WorkoutGraphAdapter extends FragmentStatePagerAdapter implements SalutronLifeTrakUtility {
	private final List<Fragment> mFragments = new ArrayList<Fragment>() {
		private static final long serialVersionUID = -6309076276787890710L;
		{
			add(FragmentFactory.newInstance(WorkoutGraphItemFragment.class));
			add(FragmentFactory.newInstance(WorkoutGraphItemFragment.class));
			add(FragmentFactory.newInstance(WorkoutGraphItemFragment.class));
		}
	};

	public WorkoutGraphAdapter(FragmentManager fm) {
		super(fm);
	}
	
	public WorkoutGraphAdapter(FragmentManager fm, Date date, int dashboardType) {
		super(fm);
		...
		WorkoutGraphItemFragment fragment1 = (WorkoutGraphItemFragment) mFragments.get(0);
		WorkoutGraphItemFragment fragment2 = (WorkoutGraphItemFragment) mFragments.get(1);
		WorkoutGraphItemFragment fragment3 = (WorkoutGraphItemFragment) mFragments.get(2);
